...
/**
* 字典类型Controller到Application层的适配
...
public interface SysDictTypeAdapterConvert {
    /**
    * 查询实体转查询上下文
    * @param query 查询实体
    * @return 查询上下文
    */
    SysDictTypeQueryContext toQuery(SysDictTypeQuery query);
    /**
    * 操作实体转操作上下文
    * @param cmd 操作实体
    * @return 操作上下文
    */
    SysDictTypeContext toContext(SysDictTypeCmd cmd);
}