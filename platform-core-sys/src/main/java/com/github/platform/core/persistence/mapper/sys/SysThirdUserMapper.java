...
public interface SysThirdUserMapper {
    ...
    */
     ...
     * @return
     */
    List<SysThirdUserBase> queryUsersByMobile(@Param("channel") String channel,@Param("mobiles") List<String> mobiles);
    /**
    * 通过实体查询
    * @param record
    ...
    */
    ...
    SysThirdUserBase findByChannel(@Param("openId")String openId, @Param("channel")String channel);
}