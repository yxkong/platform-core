 ...
 */
@Slf4j
public class KafkaDomainEventService extends AbstractDomainEventService {

    private KafkaTemplate<Object, Object> kafkaTemplate;
    private String serviceName;

    public KafkaDomainEventService(KafkaTemplate<Object, Object> kafkaTemplate, String serviceName, ApplicationContext applicationContext) {
