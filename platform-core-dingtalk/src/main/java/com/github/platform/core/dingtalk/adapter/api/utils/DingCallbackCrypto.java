package com.github.platform.core.dingtalk.adapter.api.utils;
...
public class DingCallbackCrypto {
     ...
     * @throws DingTalkEncryptException
     */
    public JSONObject getDecryptMsg(String msgSignature, String timeStamp, String nonce, String encryptMsg)
            throws DingTalkEncryptException {
        //校验签名
