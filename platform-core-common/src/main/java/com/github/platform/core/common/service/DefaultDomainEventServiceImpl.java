 ...
 * @version: 1.0
 */
public class DefaultDomainEventServiceImpl extends AbstractDomainEventService{
    public DefaultDomainEventServiceImpl(ApplicationContext applicationContext) {
