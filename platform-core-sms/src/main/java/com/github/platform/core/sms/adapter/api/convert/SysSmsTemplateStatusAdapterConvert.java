...
/**
* 模板厂商Controller到Application层的适配
...
public interface SysSmsTemplateStatusAdapterConvert {
    /**
    * 查询实体转查询上下文
    * @param query 查询实体
    * @return 查询上下文
    */
    SysSmsTemplateStatusQueryContext toQuery(SysSmsTemplateStatusQuery query);
    /**
    * 操作实体转操作上下文
    * @param cmd 操作实体
    * @return 操作上下文
    */
    SysSmsTemplateStatusContext toContext(SysSmsTemplateStatusCmd cmd);
}