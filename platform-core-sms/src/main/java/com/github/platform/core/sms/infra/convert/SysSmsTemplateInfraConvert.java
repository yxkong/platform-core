...
public interface SysSmsTemplateInfraConvert {
    /**
    * 数据库实体列表转dto列表
    * @param list 数据库实体列表
    * @return dto列表
    */
    List<SysSmsTemplateDto> toDtos(List<SysSmsTemplateBase> list);
    /**
    * 数据库实体转dto
    * @param entity 数据库实体
    * @return dto
    ...
    */
    ...
    PageBean<SysSmsTemplateDto> ofPageBean(PageInfo<SysSmsTemplateBase> pageInfo);
    ...
    * @return 数据库实体
    */
    SysSmsTemplateBase toSmsTemplateBase(SysSmsTemplateQueryContext context);
    /**
    * 实体上下文转数据库实体
    * @param context 实体上下文
    * @return 数据库实体
    */
    SysSmsTemplateBase toSmsTemplateBase(SysSmsTemplateContext context);
}